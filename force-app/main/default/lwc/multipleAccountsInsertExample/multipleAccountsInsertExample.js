...
import saveAccounts from '@salesforce/apex/MultipleAccountsCreateCls.createAccounts';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
export default class MultipleAccountsInsertExample extends LightningElement {
    @track keyIndex = 0;  
    @track error;
    @track message;
